...
if ( isset( $_POST['submit'] ) )
{
    ...
    if(mysqli_num_rows($result) >= 1)
    {
        ...
        $message_username_already_exists = "<center><h1 class='white-text card'>Sorry...The Username You Provided Already Exists On the System!!! Please Retry with a Unique Username</h1></center>";
        print_r($message_username_already_exists);
        header( "refresh:10;url=http://bcx.42web.io/create.php" );
        exit();
    }
        else{
          ...
          if ($conn->query($sql) === TRUE) {
            ...
            header( "refresh:5;url=http://bcx.42web.io/thankyou.php" );
            exit();
          } else {
...
if ( isset( $_POST['update'] ) )
{
    ...
    if ($result3 === TRUE) {
        ...
        header( "refresh:5;url=http://bcx.42web.io/create.php" );
      } else {
